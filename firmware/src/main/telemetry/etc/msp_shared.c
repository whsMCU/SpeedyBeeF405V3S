...
static uint8_t requestBuffer[MSP_TLM_INBUF_SIZE];
static uint8_t responseBuffer[MSP_TLM_OUTBUF_SIZE];
static mspPacket_t requestPacket;
static mspPacket_t responsePacket;
...
static mspDescriptor_t mspDescriptorAlloc(void)
{
