...
bool I2C_ByteWrite_IT(uint16_t DevAddress, uint16_t MemAddress, uint16_t MemAddSize, uint8_t *pData, uint16_t Size)
{
  HAL_I2C_Mem_Write_IT(&hi2c2, DevAddress<<1, MemAddress, MemAddSize, pData, Size);
  return true;
}
